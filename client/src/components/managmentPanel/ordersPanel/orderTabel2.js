...
const headCells = [
    { id: 'Klient', numeric: false, disablePadding: true, label: 'Klient' },
    { id: 'Kwota', numeric: true, disablePadding: false, label: 'Kwota' },
    { id: 'Data', numeric: true, disablePadding: false, label: 'Data' },
    { id: 'Produkty', numeric: false, disablePadding: false, label: 'Produkty' },
];
