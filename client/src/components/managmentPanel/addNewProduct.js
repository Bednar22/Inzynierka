...
const AddProduct = () => {
    ...
    return (
        <div>
            <Grid container direction='column' spacing={4} alignItems='left' style={{ marginLeft: '50px' }}>
                {' '}
                {/* GŁOWNY KONTENER */}
                <Grid item xs={4} sm={4}>
                    <TextField
                ...
                <Grid container item spacing={6}>
                    ...
                    <Grid item xs={2} sm={2}>
                        <InputLabel style={{ minWidth: '100px' }} id='demo-simple-select-label'>
                            Podkategoria
                        </InputLabel>
                        <Select
                            style={{ minWidth: '100px' }}
                ...
                <Grid item container spacing={4}>
                    {' '}
                    {/* KONTENER ZE ZDJECIEM */}
                    <Grid item container direction='column' spacing={3} xs={2} sm={2}>
                        {' '}
                        {/* KONTENER NA 2 BUTTONY */}
                        <Grid item>
