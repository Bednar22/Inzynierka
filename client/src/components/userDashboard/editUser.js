    ...
    return (
        <>
            <Grid
                ...
                sm={10}
            >
                <Grid container direction='column' alignItems='flex-start' sm={12} xs={12} spacing={4}>
                    <Grid item alignContent='flex-start'>
                        {' '}
                        <Typography>DANE:</Typography>
                    </Grid>
                    <Grid spacing={4} container item direction='row' sm={12} justify='space-evenly'>
                        {' '}
                        {/* IMIE I NAZWISKO */}
                        <Grid item sm={6} xs={6}>
                            <TextField
                    ...
                    {/* IMIE I NAZWISKO */}
                    <Grid spacing={4} container item direction='row' justify='center' sm={12}>
                        {' '}
                        {/* MAIL I TELEFON */}
                        <Grid item sm={6} xs={6}>
                            <TextField
                    ...
                    {/* MAIL I NR TELEFONU */}
                    <Grid container item direction='row' justify='center' spacing={4} sm={12}>
                        {' '}
                    ...
                    <Grid container item justify='space-between' alignItems='flex-start'>
                        <Grid item>
                            <Button onClick={() => setReadOnly(false)} variant='contained' color='secondary'>
                                ZMIEŃ
                            </Button>
                        </Grid>
                        <Grid item>
                            <Button onClick={() => submitChanges()} variant='contained' color='secondary'>
                                ZATWIERDŹ ZMIANY
                            </Button>
                        </Grid>
                    </Grid>
